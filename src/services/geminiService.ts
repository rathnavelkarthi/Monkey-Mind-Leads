...
// FIX: The `import.meta.env` property is not available in the current TypeScript configuration. Switched to `process.env.API_KEY` as per the coding guidelines.
